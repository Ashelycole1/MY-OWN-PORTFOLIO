...
export function ShareRow({ title, slug }: ShareRowProps) {
    ...
    const shareUrl = typeof window !== 'undefined' 
        ...
        : `https://ashelycole.dev/blog?post=${slug}`;
    ...
    return (
        <div className="flex flex-wrap items-center justify-between gap-4 py-4 px-5 rounded-2xl border border-border/50 bg-card/30">
            ...
            <div className="flex items-center gap-2">
                <button
                    onClick={handleCopy}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-muted hover:bg-muted/80 text-foreground transition-colors border border-border/40"
